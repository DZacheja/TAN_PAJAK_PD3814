...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Salary == (Emps.Max(x => x.Salary)));
            return result;
        }
        ...
        {
            bool result = Emps.Where(e => e.Job == "Backend programmer").Count() > 0;
            return result;
        }
        ...
        {
            IEnumerable<object> result = Emps.Join(Depts, emp => emp.Deptno, dep => dep.Deptno, (emp, dep) => new
            {
                emp.Deptno,
                dep.Dname
            })
